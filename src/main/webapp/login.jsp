...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="${pageContext.request.contextPath}/assets/js/html5.js"></script>
    <![endif]-->
    ...
    <style>
        #img{
        background-image: url("${pageContext.request.contextPath}/assets/img/1.jpg");
        }
    </style>
...
<div class="page-container" >
    <div  class="col-md-12">
        <img src="${pageContext.request.contextPath}/img/logo.png" style="width: 100px;height: 80px" >
    </div>
    <br>
    <div>
        <h1>账号登陆</h1>
        <form action="${pageContext.request.contextPath}/user/product?method=login" method="post"   >
            ...
            <input type="button" id="code" onclick="createCode()"  style="height:40px;width:120px" value="点击更换验证码"/><br>
            <p style="color: red">${logoInfo}</p>
